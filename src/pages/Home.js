    ...
    <div className='block '>
                  ...
                  <div>
                        ...
                        <div className='absolute w-11/12 mx-3 lg:mx-14  top-full'>
                              <div className=" mt-10 h-12 md:flex  lg:flex flex-wrap border">
                                    <div className="font text-black text-4xl flex-1 font-bold">Featured Movie</div>
                                    <div className=" flex gap-x-2 items-center ">
                                          <div className=" font text-rose-700 text-lg font-normal leading-normal">See more</div>
                              ...
                              <div className="Footer mt-20 w-full flex-col inline-flex items-center gap-9 ">
                                    ...
                                    <div className="Links justify-start items-start gap-4 inline-flex">
                                          <div className="ConditionsOfUse text-gray-900 font sm:text-lg font-bold">Conditions of Use</div>
                                          <div className="PrivacyPolicy text-gray-900 font sm:text-lg font-bold">Privacy & Policy</div>
                                          <div className="PressRoom text-gray-900 sm:text-lg font-bold font">Press Room</div>
                                    </div>
